...
1. [最新をダウンロード](https://github.com/toiee-lab/wordpress-to-qhm-migrator/archive/master.zip) します。
2. WordPressにログインし、管理画面 > プラグイン > 新規追加 を選びます
3. プラグインのアップロードを選び、先ほどダウンロードしたzipファイルを指定します
4. 有効化します

### 更新方法

ver 0.6以後の場合は、自動的に更新通知が表示されます。更新ボタンを押して、更新してください。

ver 0.6以前の方は、プラグインを削除し、もう一度、インストールしてください。
...
9. **index.php を入れ替え、index_qhm.php を用意する** : QHMのindex.php を index_qhm.php に、WordPressの index.php (index_wp.php) を index.php とします。ver0.8.1 からは、プラグインの画面から行えます。
